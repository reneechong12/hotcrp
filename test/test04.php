...
$u = $Conf->ensure_user_by_author(Author::make_keyed(["email" => "betty1@_.com", "name" => "Betty Grable"]));
xassert_eqq($u->firstName, "Betty");
xassert_eqq($u->lastName, "Grable");
$u = $Conf->contactdb_user_by_email("betty1@_.com");
xassert_eqq($u->firstName, "Betty");
xassert_eqq($u->lastName, "Grable");
$u = $Conf->ensure_user_by_author(Author::make_keyed(["email" => "betty2@_.com", "name" => "Betty Apiafi"]));
xassert_eqq($u->firstName, "Betty");
xassert_eqq($u->lastName, "Apiafi");
$u = $Conf->contactdb_user_by_email("betty2@_.com");
xassert_eqq($u->firstName, "Betty");
xassert_eqq($u->lastName, "Apiafi");
$u = $Conf->ensure_user_by_author(Author::make_keyed(["email" => "betty3@_.com", "name" => "Betty Crocker"]));
xassert_eqq($u->firstName, "Betty");
xassert_eqq($u->lastName, "Shabazz");
$u = $Conf->contactdb_user_by_email("betty3@_.com");
xassert_eqq($u->firstName, "Betty");
xassert_eqq($u->lastName, "Shabazz");
$u = $Conf->ensure_user_by_author(Author::make_keyed(["email" => "betty4@_.com", "name" => "Betty Crocker", "affiliation" => "France"]));
xassert_eqq($u->firstName, "Betty");
...
$u = $Conf->ensure_user_by_email("cengiz@isi.edu");
